...
class Behaviour {
  ...
  expectFooterToBeInBaseState(): void {
    ...
    expect(this.page.footer.twitterSocialLink).toBe(CONSTANTS.SOCIAL.TWITTER);
    expect(this.page.footer.facebookSocialLink).toBe(CONSTANTS.SOCIAL.FACEBOOK);
    expect(this.page.footer.linkedinSocialLink).toBe(CONSTANTS.SOCIAL.LINKEDIN);
